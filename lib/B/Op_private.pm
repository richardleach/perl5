...
@{$bits{sassign}}{7,6,5,1,0} = ('OPpASSIGN_CV_TO_GV', 'OPpASSIGN_BACKWARDS', 'OPpASSIGN_WAS_LIST', $bf[1], $bf[1]);
$bits{scalar}{0} = $bf[0];
$bits{schomp}{0} = $bf[0];
$bits{schop}{0} = $bf[0];
...
$ops_using{OPpASSIGN_WAS_LIST} = $ops_using{OPpASSIGN_BACKWARDS};
