...
This clearly sets the scope of which changes are to be summarised in the
...
Any significant errata, especially arising from previous stable/maintenance
releases should go here. Minor errata are not usually worthy of mention.
